                    ...
                    <motion.div
                        ...
                        className={cn(
                            ...
                            isScrolled
                                ...
                                : "border-slate-200/70 bg-white/82 backdrop-blur-lg dark:border-white/10 dark:bg-slate-950/72"
                        )}
                    >
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="mt-4 grid gap-3">
                                <LanguageToggle className="justify-center border-slate-200 bg-white text-slate-700 dark:border-white/10 dark:bg-white/[0.06] dark:text-white" />
