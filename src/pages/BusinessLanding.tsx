            ...
            <motion.div variants={fadeUp} className="relative mx-auto w-full max-w-[620px]">
              ...
              <div className="relative overflow-hidden rounded-[34px] border border-white/80 bg-white/90 p-3 shadow-[0_35px_100px_rgba(75,36,52,0.18)] backdrop-blur-xl dark:border-white/10 dark:bg-[#18101b]/92 dark:shadow-black/45 sm:p-5">
                <div className="flex items-center justify-between px-2 pb-4 pt-1 sm:px-3">
                  <div><div className="text-xs font-bold uppercase tracking-[0.16em] text-[#665764] dark:text-[#cbbfc6]">{text.preview}</div><div className="mt-1 text-lg font-bold text-[#2b0d35] dark:text-white">Vizit workspace</div></div>
                ...
                <div className="grid gap-3 sm:grid-cols-[150px_1fr]">
                  ...
                  <div className="rounded-[24px] border border-[#eee3d7] bg-[#fffaf5] p-4 dark:border-white/8 dark:bg-white/[0.04] sm:p-5">
                    <div className="flex items-center justify-between"><div><div className="text-xs font-semibold text-[#665764] dark:text-[#cbbfc6]">{text.today}</div><div className="mt-1 text-2xl font-bold text-[#2b0d35] dark:text-white">3</div></div><div className="rounded-2xl bg-[#1e9e92]/10 p-3 text-[#167d74]"><CalendarDays className="h-5 w-5" /></div></div>
                    <div className="mt-5 space-y-2.5">
                      {text.schedule.map(([time, service, staff]) => <div key={`${time}-${service}`} className="grid grid-cols-[52px_1fr] gap-3 rounded-2xl border border-[#eadfd4] bg-white px-3 py-3 dark:border-white/8 dark:bg-white/[0.05]"><div className="flex items-center gap-1 text-xs font-bold text-[#6d2a63] dark:text-[#f0c8e8]"><Clock3 className="h-3.5 w-3.5" />{time}</div><div className="min-w-0"><div className="truncate text-sm font-bold text-[#3d243c] dark:text-white">{service}</div><div className="mt-1 flex items-center justify-between gap-2 text-[11px] text-[#665764] dark:text-[#cbbfc6]"><span>{staff}</span><span className="rounded-full bg-emerald-50 px-2 py-1 font-semibold text-emerald-700 dark:bg-emerald-500/12 dark:text-emerald-200">{text.confirmed}</span></div></div></div>)}
                    </div>
                  </div>
                </div>
              </div>
