      ...
      <motion.form variants={staggerContainer(0.08)} initial="hidden" animate="show" onSubmit={submit} className="space-y-5">
        ...
        <motion.div variants={fadeUp}>
          <div className="mb-2 flex items-center justify-between gap-3">
            <label htmlFor="client-login-password" className="block text-sm font-medium text-slate-700">{text.password}</label>
            <Link to="/forgot-password?audience=client" className="text-xs font-medium text-slate-500 transition hover:text-violet-700">{text.forgot}</Link>
          </div>
          <div className="relative">
