...
export default function PrivacyPolicy() {
  return (
    <LegalPageTemplate
      ...
      description="Ինչ տվյալներ է մշակում Vizit-ը, ինչ նպատակով և ինչ սահմաններում է դա արվում ծառայությունը կայուն ու անվտանգ պահելու համար։"
      updatedAt={updatedAt}
      sections={[
        {
          title: "1. Ովքեր ենք",
          content: (
            <p>
              Vizit-ը ամրագրման և scheduling հարթակ է գեղեցկության սրահների, կլինիկաների և
